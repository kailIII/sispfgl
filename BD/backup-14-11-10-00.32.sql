...
SELECT pg_catalog.setval('capacitacion_cap_id_seq', 31, true);
...
SELECT pg_catalog.setval('facilitador_fac_id_seq', 6, true);
...
SELECT pg_catalog.setval('informe_preliminar_inf_pre_id_seq', 1, true);
...
SELECT pg_catalog.setval('login_attempts_id_seq', 3, true);
...
SELECT pg_catalog.setval('opcion_sistema_opc_sis_id_seq', 22, true);
...
SELECT pg_catalog.setval('participante_par_id_seq', 38, true);
...
SELECT pg_catalog.setval('reunion_reu_id_seq', 84, true);
...
COPY capacitacion (cap_id, cap_fecha, cap_tema, cap_lugar, cap_observacion, pro_pep_id, cap_area) FROM stdin;
20	2012-11-07	El beneficio de las finanzas	Casa Comunal La Gloria	0	7	Finanzas
\.
...
efa22a0b9ecb7594266dc2f4444bd380	127.0.0.2	Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.4 (KHTML, like Gecko) Chrome/22.0.1229.94 Safari/537.4	1352874495	a:4:{s:9:"user_data";s:0:"";s:7:"user_id";s:1:"9";s:8:"username";s:11:"cfuentes_86";s:6:"status";s:1:"1";}
\.
...
COPY informe_preliminar (inf_pre_id, inf_pre_fecha_borrador, inf_pre_fecha_observacion, inf_pre_aceptacion, inf_pre_aceptada, inf_pre_firmam, inf_pre_firmai, inf_pre_firmau, inf_pre_observacion, pro_pep_id, inf_pre_ruta_archivo) FROM stdin;
1	\N	\N	\N	\N	\N	\N	\N	\N	7	documentos/informe_preliminar/informe_preliminar1.docx
\.
...
20	Gestión Consultor	consultor/consultoraC/consultores	17	2
...
COPY participante (par_id, gru_apo_id, reu_id, ins_id, dec_int_id, inf_pre_id, par_nombre, par_apellido, par_sexo, par_cargo, par_edad, par_nivel_esco, par_tel, par_dui, par_proviene, acu_mun_id, par_otros) FROM stdin;
19	\N	68	2	\N	\N	sdddf	fadfad	M	dfadf	\N	\N	\N	\N	\N	\N	\N
18	\N	68	2	\N	\N	fdfad	fdafd	M	fdafd	\N	\N	\N	\N	\N	\N	\N
20	\N	68	2	\N	\N	ariana	Fuentes	F	Gerente	\N	\N	\N	\N	\N	\N	\N
21	\N	\N	2	1	\N	Mina 	de Peñate	F	Jefe	\N	\N	0        	\N	\N	\N	\N
1	1	\N	\N	\N	\N	Stephanie 	Peñate	F	Jefa	25	Bachillerato	2278-9635	03417447-9	\N	\N	\N
2	1	\N	\N	\N	\N	Ariana 	Fuentes	F	Super Jefa	15	prepa	2276-1824	\N	\N	\N	\N
\.
...
7	Proyecto de arreglo de una calle empedrada	\N	192	13	1	2	1	\N	\N	\N
\.
...
1	admin	$2a$08$orzZRVsYd7hePXoZ7s61De5ecu2TD9OIZMqYpA6jvHv44eH8qp31W	karensita_2410@hotmail.com	1	0	\N	\N	\N	\N	\N	127.0.0.2	2012-11-13	2012-08-19	\N	1
9	cfuentes_86	$2a$08$E8ttuLm0U2cD5lHo8/bzxuPeOJw/8/8nXH912APeL12wCUl4hNbNO	cfuentes_86@hotmail.com	1	0	\N	\N	\N	\N	\N	127.0.0.2	2012-11-13	2012-09-12	\N	3
\.
...
ALTER TABLE ONLY facilitador
    ADD CONSTRAINT fk_capacitacion_facilitador FOREIGN KEY (cap_id) REFERENCES capacitacion(cap_id);
