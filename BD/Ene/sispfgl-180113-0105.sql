...
SELECT pg_catalog.setval('acuerdo_municipal_acu_mun_id_seq', 24, true);
...
SELECT pg_catalog.setval('consultor_con_id_seq', 18, true);
...
SELECT pg_catalog.setval('"proyecto_Pep_pro_pep_id_seq"', 16, true);
...
SELECT pg_catalog.setval('user_profiles_id_seq', 16, true);
...
15	Usuario1	$2a$08$ltMsPaPH5RlS7Sqyg85RxujiUaNoBQPFeOeY/t5cZoLhKECOZ2svC	kpenate3@salud.gob.sv	1	0	\N	\N	\N	\N	\N	127.0.0.1	2013-01-18	2013-01-18	\N	3
...
1	admin	$2a$08$orzZRVsYd7hePXoZ7s61De5ecu2TD9OIZMqYpA6jvHv44eH8qp31W	karensita2410@hotmail.com	1	0	\N	\N	\N	\N	\N	127.0.0.1	2013-01-18	2012-08-19	\N	1
