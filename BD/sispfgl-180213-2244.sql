...
COPY aporte_municipal (apo_mun_id, apo_mun_monto_estimado, apo_mun_faprobacion, apo_mun_observaciones, mun_id) FROM stdin;
\.
...
eea1388f39745086fb90561385338c3d	127.0.0.1	Mozilla/5.0 (X11; Linux x86_64; rv:10.0.12) Gecko/20100101 Firefox/10.0.12 Iceweasel/10.0.12	1361248462	a:3:{s:7:"user_id";s:2:"15";s:8:"username";s:7:"kpenate";s:6:"status";s:1:"1";}
\.
...
SELECT pg_catalog.setval('consultores_interes_con_int_id_seq', 1, true);
...
COPY contrapartida_aporte (con_id, apo_mun_id, con_apo_valor) FROM stdin;
\.
...
SELECT pg_catalog.setval('proceso_etapa_pro_eta_id_seq', 26, true);
...
SELECT pg_catalog.setval('proceso_pro_id_seq', 1, true);
...
15	kpenate	$2a$08$iDSnhWfSv6y1epb6zuf2q.rW9tketjzk5Y9Vv9ZvnF6Xv/8tOS2Pq	kpenate@salud.gob.sv	1	0	\N	\N	\N	\N	\N	127.0.0.1	2013-02-18	2013-02-01	\N	5
...
--
-- Name: fk_aporte_municipañ_contrapartida_aporte; Type: FK CONSTRAINT; Schema: public; Owner: sispfgl
--

ALTER TABLE ONLY contrapartida_aporte
    ADD CONSTRAINT "fk_aporte_municipañ_contrapartida_aporte" FOREIGN KEY (apo_mun_id) REFERENCES aporte_municipal(apo_mun_id) ON UPDATE CASCADE ON DELETE CASCADE;
