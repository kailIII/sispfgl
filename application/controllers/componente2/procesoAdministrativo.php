...
class ProcesoAdministrativo extends CI_Controller {
    ...
    public function guardarAdquisicionContrataciones() {
        $this->load->model('procesoAdministrativo/proceso');
    ...
    public function evaluacionExpresionInteres() {
     ...
     public function guardarEvaluacionExpresion() {
        $this->load->model('procesoAdministrativo/proceso');
        ...
        redirect('componente2/procesoAdministrativo/evaluacionExpresionInteres');
    }
