...
class Comp24_E2 extends CI_Controller {
    
    private $ruta = "componente2/subcomp24/etapa2/";
	...
	public function revisionAprobacionProductos($id = false){
	   ...
	   $tabla = 'revapro_productos2';
        ...
        $config = array(
            ...
            array('field' => $prefix.'is_informe_etapa'  , 'label' => 'Fecha', 'rules' => 'trim|required|xss_clean'),
            array('field' => $prefix.'is_borrador'       , 'label' => 'Fecha', 'rules' => 'trim|required|xss_clean'),
        ...
        if ($this->form_validation->run())
        {
            $datos = array(
                ...
                $prefix.'is_informe_etapa'  =>  $this->form_validation->set_value($prefix.'is_informe_etapa'),
                $prefix.'is_borrador'       =>  $this->form_validation->set_value($prefix.'is_borrador'),
