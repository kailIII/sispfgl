...
/*
  ...
  |--------------------------------------------------------------------------
 */
$config['website_name'] = 'SIS-PFGL';
$config['webmaster_email'] = 'sis-pfgl@gmail.com';
...
$config['email_activation_expire'] = 60 * 60 * 24 * 20;
...
/*
  ...
  |--------------------------------------------------------------------------
 */
$config['forgot_password_expire'] = 60 * 15 * 40 * 20;
