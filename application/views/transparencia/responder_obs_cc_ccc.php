   ...
   $(document).ready(function(){
	...
	var tab2=$("#ccc");
     ...
     $('#myform').submit(function(){
			$('#enviando').empty();
			$('#enviando').append('<spam style="color:blue"> enviando...</spam>');
		return true;
	 });
...
<h1>Responder Observaci&oacute;n</h1>
<br/>

<?php $attributes = array('id' => 'myform');
	echo form_open('transparencia/observaciones_cc_ccc/enviar_respuesta/'.$id.'',$attributes);
?>	
	...
	<input type="text" name="email" id="email"  size="20"><label id="email_valid"></label>
	<br/><br/>
	
	<label>Respuesta a la observaci&oacute;n realizada: </label><br/>
	<textarea rows="5" cols="75" maxlength="500" name="resp" id="resp" align="center"></textarea>
	</br></br>
    
    <input type="hidden" value="<?php echo $tipo?>" name="tipo" />
    
    <br/>
    <input type="submit" id="guardar" name="guardar" value="Enviar Respuesta" /><label id="enviando"> <font size=1>Ser&aacute; enviado al correo electr&oacute;nico de la persona.</font></label>
	<div id="divpost" ></div>
<?php echo form_close();?>
