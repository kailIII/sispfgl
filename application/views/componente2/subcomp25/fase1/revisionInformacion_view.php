<script type="text/javascript">
    $(document).ready(function() {
        ...
        function validaTipoMapa(value, colname) {
            if (value == 0)
                return [false, "Seleccione un tipo de mapa"];
            else
                return [true, ""];
        }
        var tabla4 = $("#mapa");
    ...
    <div id="parte1">
        <form id="revisionInformacion1" method="post">
            ...
            <table>
                ...
                <td width="40"></td>
                <td  width="90"> <input type="radio" name="rev_inf_gestion_reactiva" value="true" > SI </input>
                    <input type="radio" name="rev_inf_gestion_reactiva" value="false"> NO</input>
                </td>
                <td width="40"></td>
                <td><input id="rev_inf_ogestion_reactiva" name="rev_inf_ogestion_reactiva" value="" type="text" size="30" maxlength="255" /></td>
                </tr>
                <tr>
                ...
                <td width="40"></td>
                <td><input id="rev_inf_ogestion_correctiva" name="rev_inf_ogestion_correctiva" value="" type="text" size="30" maxlength="255"/></td>
                </tr>
                <tr>
                ...
                <td width="40"></td>
                <td><input id="rev_inf_ogestion_prospectiva" name="rev_inf_ogestion_prospectiva" value="" type="text" size="30" maxlength="255"/></td>
                </tr>
            </table>
            </p>
            <p>
