    ...
    $("#otros").jqGrid({
        ...
        colModel:[
            ...
            {name:'par_edad',index:'par_edad', width:50,editable:true,align:'center',
                edittype:'text',editoptions:{size:5,maxlength:2},
                editrules:{required:true,required:true,number:true,minValue:0,maxValue:100} },
            {name:'par_cargo',index:'par_cargo', width:123,editable:true,editoptions:{size:30},
                edittype:'text',editoptions:{size:20,maxlength:50},
                editrules:{required:false} },
             {name:'par_telefono',index:'par_telefono', width:100,editable:true,editoptions:{size:8},align:'center',
                edittype:'text',editoptions:{size:10,maxlength:9,dataInit:function(el){$(el).mask("9999-9999",{placeholder:" "});}}
                }
        ],
        multiselect: false,
...
<?php echo form_open('',array('id'=>'frm')) ?>
    ...
    <div id="rpt_frm_bdy">
        ...
        <div id="formulario" style="display: none;">
            ...
            <div class="campo">
                <label style="text-align: left; width: 620px;">Divulgo el concejo municipal el informe de desempeño administrativo financiero?</label>
                <span>Si</span><input type="radio" name="seg_eva_is_divulgado" value="t" <?php echo set_radio('seg_eva_is_divulgado', 't'); ?>/>
                <span>No</span><input type="radio" name="seg_eva_is_divulgado" value="f" <?php echo set_radio('seg_eva_is_divulgado', 'f', TRUE); ?>/>
                <?php echo form_error('seg_eva_is_divulgado'); ?>
            </div>
            <div class="campo">
                <label>Por que?</label>
                <textarea id="seg_eva_porque" name="seg_eva_porque" rows="5" wrap="virtual" style="width: 500px;"><?php echo set_value('seg_eva_porque')?></textarea>
                <?php echo form_error('seg_eva_porque'); ?>
            </div>
            <div style="width: 100%;">
