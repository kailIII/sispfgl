...
<?php echo form_open() ?>
    ...
    <div id="rpt_frm_bdy">
        ...
        <div class="campo">
            <label style="width: 400px;">Fecha de envio de acuerdo municipal</label>
            <input <?php if (isset($f_emision)) { ?> value='<?php echo date('d/m/Y', strtotime($f_emision)); ?>'<?php } ?>id="f_vistobueno" name="f_vistobueno" type="text" size="10" readonly="readonly"/>
        </div>
        <div class="campo">
                <label style="width: 400px;">Registro de Rubros a invertir</label>
                <span>Asistencia Tecnica</span><input type="radio" name="t_planTrabajo" value="yes" />
                <span>Equipamiento</span><input type="radio" name="t_planTrabajo" value="no" checked="checked" />
        </div>
        <div class="campo">
            <label style="width: 400px;">Descripcion</label>
