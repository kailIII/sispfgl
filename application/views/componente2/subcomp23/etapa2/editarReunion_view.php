<script type="text/javascript">        
    $(document).ready(function(){
        ...
        $("#cancelar").button().click(function() {
            document.location.href='<?php echo base_url('componente2/comp23_E2/muestraReuniones'); ?>';
        });
...
<form id="reunionForm" method="post">
    ...
    <table>
        <tr>
        <td colspan="3">
            <p><strong>Nombre de la actividad:</strong><textarea id="reu_resultado" name="reu_resultado" cols="50" rows="1" class="required" ><?php echo $reu_resultado ?></textarea></p>
        </td>
        <td width="300">
            Fecha: 
            <input id="reu_fecha" name="reu_fecha" value="<?php echo $reu_fecha ?>" readonly="readonly" class="required"  size="10"/>
        </td>
        </tr>
    </table>
    ...
    <p><input type="checkbox" name="pob_comunidad" <?php if (!strcasecmp($pob_comunidad, 't')) { ?> checked="checked" <?php } ?> value="1" >Comunidad</input>
        <input type="checkbox" name="pob_sector" <?php if (!strcasecmp($pob_sector, 't')) { ?> checked="checked" <?php } ?> value="1" >Sector</input>
        <input type="checkbox" name="pob_institucion" <?php if (!strcasecmp($pob_institucion, 't')) { ?> checked="checked" <?php } ?>value="1" >Institución</input>
    </p>
