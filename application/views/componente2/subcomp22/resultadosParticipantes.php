...
$(document).ready(function(){
    ...
    $("#miembros").jqGrid({
        ...
        height: 300,
        hidegrid: false,
        colNames:['id','Nombres','Apellidos','Municipalidad','Estado','Promedio Final','Constancia de Finalización', 'Observaciones'],
        colModel:[
    ...
    $('#btn_editar').button().click(function(){
        $('#miembros').jqGrid('editRow',$('#miembros').jqGrid('getGridParam', 'selrow'),true);
    });
    /**/
