...
$(document).ready(function(){
    /*BASICO*/
    function formularioHide(){$('#listaContainer').show();$('#formulario').hide();$('#procesos').hide()}
    function formularioShow(){$('#listaContainer').hide();$('#formulario').show();$('#procesos').show()}
    $("#guardar").button();$("#guardar2").button();$("#guardar3").button();
    ...
    $("#cancelar #cacelae2 #cancelar3").button().click(function() {document.location.href='<?php echo base_url(); ?>';});
    ...
    jqLista.jqGrid({
        ...
        width: 300,
       	...
       	colModel:[
       		...
       		{name:'par_nombres',index:'par_nombres', width:100},
            {name:'par_apellidos',index:'par_apellidos', width:100}				
       	],
       	rowNum:10,
       	rowList:[10,20,30],
       	pager: '#pagerLista',
...
<?php echo form_open('',array('id'=>'frm_acuerdo_municipal2')) ?>
    ...
    <h2 class="h2Titulos">Formulario de Registro y Preselección00</h2>
    <br/>
    <div id="rpt_frm_bdy">
