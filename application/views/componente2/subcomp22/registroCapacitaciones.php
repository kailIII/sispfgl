...
$(document).ready(function(){
    ...
    /**/
    var download_path = '<?php $t=set_value('cap_archivo'); if($t!=''){echo base_url($t);}?>';
    ...
    <div id="rpt_frm_bdy">
        ...
        <div id="formulario" style="display: none;">
            ...
            <div class="campo">
                ...
                <?php echo form_dropdown('mod_id',$cap_modalidad,set_value('mod_id','0')); echo form_error('mod_id'); ?>
            </div>
            <div class="campo">
