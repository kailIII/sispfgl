<script type="text/javascript">        
    $(document).ready(function(){    
        ...
        $("input[name='regresar']").button().click(function() {
...
<tr>
<td class="letraazul"><label id="region">Región:</label></td>
<td>
    <?php echo form_dropdown('reg_id', $regiones); ?>
</td>
<td class="error"><?php echo form_error($reg_id['name']); ?><?php echo isset($errors[$reg_id['name']]) ? $errors[$reg_id['name']] : ''; ?></td>
</tr> 
<tr>
<td colspan="3" align="center"><?php echo form_submit('register', 'Registrar'); ?>
