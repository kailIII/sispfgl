...
echo form_open_multipart('gestion_componentes/financiera/realizar_transferencia', $attributes);?>
	...
	<div  style="float:left;height:300px;width:800px;box-shadow: 1px 10px 5px #D3D1D1;">
		<br/><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<label><b>Cuenta Destino</b></label><br/><br/>
		
		<label>Componente: </label>
		<?php echo form_dropdown_from_db('comd','comd',"SELECT com_id,com_codigo || '.  ' || com_nombre FROM componente where com_tipo='Componente'");?><br/>
		
		<label>Subcomponente: </label>
		<select id='subcomd' name='subcomd'>
					<option value='0'>--Seleccione--</option>
		</select><br/>
		
		<label>Macroactividad: </label>
		<select id='macroactd' name='macroactd'>
					<option value='0'>--Seleccione--</option>
		</select><br/>
		
		<label>Actividad: </label>
		<select id='actd' name='actd'>
					<option value='0'>--Seleccione--</option>
		</select><br/>
		
		<label>Subactividad: </label>
		<select id='subactd' name='subactd'>
					<option value='0'>--Seleccione--</option>
		</select><br/>
		...
		<label>GOES </label>
		<input type="text" name="goesd" id="goesd"  size="6" readonly="readonly">&nbsp;&nbsp;
		
		<label>GMUN </label>
		<input type="text" name="gmund" id="gmund"  size="6" readonly="readonly">&nbsp;&nbsp;
		
		<label>BIRF </label>
		<input type="text" name="birfd" id="birfd"  size="6" readonly="readonly">&nbsp;&nbsp;
		
		<br/><br/><label>Saldo: </label>
		<input type="text" name="saldod" id="saldod"  size="6" readonly="readonly">&nbsp;&nbsp;
	...
	<div  style="float:left;height:300px;width:800px;box-shadow: 1px 10px 5px #D3D1D1;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<label><b>Transferencia a Realizar</b></label><br/><br/>
		
		<label>Fecha Transferencia: </label>
		<input type="text" value='<?php echo date('Y-m-d')?>' readonly="readonly" name="trans_fecha" id="trans_fecha"  size="5"><br/><br/>
		...
		<label>BIRF </label>
		<input type="text" name="birft" id="birft"  size="6">&nbsp;&nbsp;
		
		<input type="submit" id="guardar" value="Transferir" align="right" name="guardar"><br/><br/>
		
		<label>Descricpion de la acci&oacute;n: </label>
		<input type="text" name="trans_desc" id="trans_desc"  size="25"><br/><br/>
		
		<label>Observaci&oacute;n o comentario: </label>
		<input type="text" name="trans_obs" id="trans_obs"  size="25">&nbsp;&nbsp;
