<div style="margin-left: 250px;">
        ...
        <h1>Proyecto de Fortalecimiento de los Gobiernos Locales </h1>
        </br>
        <h3  class="h2Titulos">Objetivo General</h3>
        ...
        <h3  class="h2Titulos">Objetivos Específicos</h3>
        <ol>
            ...
            a través de la intervenciòn del proyecto</li>
        </ol>
