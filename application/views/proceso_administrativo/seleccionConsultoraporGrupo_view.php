...
<form id="SeleccionConsultoras" method="post">

    <h2 class="h2Titulos">Selección de Consultoras por Grupo de Municipios</h2>
    <br/>
    ...
    <table>
        <tr>
        <td>
            <strong>Fecha de envio de informacion: </strong>
        </td> 
        <td>
            <input id="fecha_envio_info" name="fecha_recep_info" type="text" size="10" readonly="readonly"/>
        </td>
        </tr>

        <tr>

        <td> <strong>Fecha de limite de recepcion de información: </strong>
        </td>

        <td>
            <input id="fecha_recep_info" name="fecha_recep_info" type="text" size="10" readonly="readonly"/>    
        </td>
