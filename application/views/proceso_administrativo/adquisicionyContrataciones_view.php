...
<form id="AdquisicionyContratacionForm" method="post">
    ...
    <table><tr>
        ...
        <td>
            <input id="fecha_publicacion" name="fecha_publicacion" type="text" size="10" readonly="readonly"/>
        </td>
        </tr>

        <tr>

        <td> <strong>Fecha de aclaración de dudas: </strong>
        </td>

        <td>
            <input id="fecha_dudas" name="fecha_dudas" type="text" size="10" readonly="readonly"/>    
        </td>

        </tr>

        <tr>
        <td><strong>Fecha limite de expresión de interes: </strong>
        </td>
        <td><input id="fecha_interes" name="fecha_interes" type="text" size="10" readonly="readonly"/>
        </td>
