...
<?php if(isset($aviso))
	echo $aviso;?>
<h1>Subir Archivo POA - Gestion de Riesgo</h1>
<br/>
...
echo form_open_multipart('poa/poa/guardar_poa_gr',$attributes);?>
	...
	<div  style="float:left;height:120px;width:400px;">
		...
		<input type="text" name="anio_gr" id="anio_gr"  size="7" >
	...
	<div  style="float:left;height:120px;width:500px;">
		<label>Estado: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<select name="estado_gr" size="1" id="estado_gr">
			<option value="En Ejecucion"<?php echo set_select('estado_gr', 'En Ejecucion'); ?>>En Ejecuci&oacute;n</option>
			<option value="Finalizado"<?php echo set_select('estado_gr', 'Finalizado'); ?>>Finalizado</option>
			<option value="Retrasado"<?php echo set_select('estado_gr', 'Retrasado'); ?>>Retrasado</option>
			<option value="Cancelado"<?php echo set_select('estado_gr', 'Cancelado'); ?>>Cancelado</option>
		</select>
		<br/><br/>
