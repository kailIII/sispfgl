...
<table id="box-table-a">
    ...
    <tbody>
        <?php foreach ($actividades as $aux) { ?>
            ...
            <td><input class='boton' type="button" onclick="location.href=('<?php echo base_url($ruta . "gestionarActividad") . "/" . $poa_com_id . "/" . $aux->poa_act_id; ?>')" value="Editar" />
            <!--    <input class='boton' type="button" onclick="alert(<?php echo $aux->poa_act_id; ?>)" value="Eliminar" />-->
                <input class='boton' type="button" onclick="location.href=('<?php echo base_url($ruta . "gestionarSubActividad") . "/" . $poa_com_id . "/" . $aux->poa_act_id; ?>')" value="Agregar SubActividad" /></td>
            </tr>
            <?php if (count($ci->actividad->obtenerSubActividades($aux->poa_act_id)) != 0) { ?>
                <?php foreach ($ci->actividad->obtenerSubActividades($aux->poa_act_id) as $aux2) { ?>
                    ...
                    <td><input class='boton' type="button"  onclick="location.href=('<?php echo base_url($ruta . "gestionarActividad") . "/" . $poa_com_id . "/" . $aux2->poa_act_id; ?>')" value="Editar" />
                    <!--    <input class='boton' type="button" onclick="alert(<?php echo $aux2->poa_act_id; ?>)" value="Eliminar" />-->
                        <input class='boton' type="button" onclick="location.href=('<?php echo base_url($ruta . "gestionarSubActividad") . "/" . $poa_com_id . "/" . $aux2->poa_act_id; ?>')" value="Agregar SubActividad" />
                    </td>
                    </tr>
                    <?php if (count($ci->actividad->obtenerSubActividades($aux2->poa_act_id)) != 0) { ?>
                        <?php foreach ($ci->actividad->obtenerSubActividades($aux2->poa_act_id) as $aux3) { ?>
                            ...
                            <td><input class='boton' type="button"  onclick="location.href=('<?php echo base_url($ruta . "gestionarActividad") . "/" . $poa_com_id . "/" . $aux3->poa_act_id; ?>')" value="Editar" />
                            <!--    <input class='boton' type="button" onclick="alert(<?php echo $aux3->poa_act_id; ?>)" value="Eliminar" />-->
                                <input class='boton' type="button" onclick="location.href=('<?php echo base_url($ruta . "gestionarSubActividad") . "/" . $poa_com_id . "/" . $aux3->poa_act_id; ?>')" value="Agregar SubActividad" /></td>
                            </tr>
                            <?php if (count($ci->actividad->obtenerSubActividades($aux3->poa_act_id)) != 0) { ?>
                                <?php foreach ($ci->actividad->obtenerSubActividades($aux3->poa_act_id) as $aux4) { ?>
                                    ...
                                    <td><input class='boton' type="button"  onclick="location.href=('<?php echo base_url($ruta . "gestionarActividad") . "/" . $poa_com_id . "/" . $aux4->poa_act_id; ?>')" value="Editar" />
                                    <!--    <input class='boton' type="button" onclick="alert(<?php echo $aux4->poa_act_id; ?>)" value="Eliminar" />-->
                                        <input class='boton' type="button" onclick="location.href=('<?php echo base_url($ruta . "gestionarSubActividad") . "/" . $poa_com_id . "/" . $aux4->poa_act_id; ?>')" value="Agregar SubActividad" /></td>
                                    </tr>
                                    <?php if (count($ci->actividad->obtenerSubActividades($aux4->poa_act_id)) != 0) { ?>
                                        <?php foreach ($ci->actividad->obtenerSubActividades($aux4->poa_act_id) as $aux5) { ?>
                                            ...
                                            <td><input class='boton' type="button"  onclick="location.href=('<?php echo base_url($ruta . "gestionarActividad") . "/" . $poa_com_id . "/" . $aux5->poa_act_id; ?>')" value="Editar" />
                                                <input class='boton' type="button" onclick="location.href=('<?php echo base_url($ruta . "gestionarSubActividad") . "/" . $poa_com_id . "/" . $aux5->poa_act_id; ?>')" value="Agregar SubActividad" /></td>
                                    <!--    <input class='boton' type="button" onclick="alert(<?php echo $aux4->poa_act_id; ?>)" value="Eliminar" /></td>-->
                                            ...
                                            <?php if (count($ci->actividad->obtenerSubActividades($aux5->poa_act_id)) != 0) { ?>
                                                <?php foreach ($ci->actividad->obtenerSubActividades($aux5->poa_act_id) as $aux6) { ?>
                                                    ...
                                                    <td><input class='boton' type="button"  onclick="location.href=('<?php echo base_url($ruta . "gestionarActividad") . "/" . $poa_com_id . "/" . $aux6->poa_act_id; ?>')" value="Editar" />
                                            <!--    <input class='boton' type="button" onclick="alert(<?php echo $aux4->poa_act_id; ?>)" value="Eliminar" /></td>-->
                                                    </tr>
                                                <?php } ?>
                                            <?php } ?>
