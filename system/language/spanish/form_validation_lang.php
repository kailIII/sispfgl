...
$lang['valid_url']             = "El campo %s debe contener una URL válidas.";
$lang['valid_ip']             = "El campo %s debe contener una IP válidas.";
...
$lang['integer']            = "El campo %s debe contener un némero entero.";
$lang['matches']            = "El campo %s no coincide con el campo %s.";
$lang['is_natural']            = "El campo %s debe contener sólo némeros positivos.";
$lang['is_natural_no_zero']    = "El campo %s debe contener un némero mayor que cero.";
